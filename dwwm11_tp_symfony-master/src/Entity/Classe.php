...
class Classe
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Prof::class, inversedBy="clasesPrincipales")
    ...
    public function getProfesseurPrincipal(): ?Prof
    {
        return $this->professeurPrincipal;
    }

    public function setProfesseurPrincipal(?Prof $professeurPrincipal): self
    {
