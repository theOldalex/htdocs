...
$articles = array(
    ...
    array(
        'titre' => 'Le titre d\'un super article 4 ajouté a posteriori',
        'date' => 'Le 11/08/2021',
        'contenu' =>
        'Les recherches archéologiques ont démontré que les Hommes ont vécu dans la région de Jongensfontein durant sept mille ans. Les premiers habitants étaient des chasseurs-cueilleurs avant que des bovins ne soient introduits il y a environ deux mille ans, laissant la place à une population pastorale. Le secteur dispose notamment d\'une source d\'eau douce située à quelques centaines de mètres de la plage et vitale pour le bétail.
            ...
            En 1916, la ferme est subdivisée en lots et parcelles vendus à 31 personnes qui commencent à construire des maisons et des bungalows destinés à la villégiature et à la location de vacances. Au début, Jongensfontein et Stilbaai West ne sont accessibles que par un ferry traversant la rivière Kaffirkuils (maintenant appelée la rivière Gouka). Un pont enjambe aujourd\'hui la rivière permettant à la route R305 de rejoindre Jongensfontein.',
        'lien' => 'article4.php',
        'image' => 'https://picsum.photos/1500/1000',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo Lorem Picsum',
    ),
    array(
        'titre' => 'Allons-y gaiement !',
        'date' => 'Le 11/08/2021',
        'contenu' =>
        'L\'idée de créer un lieu ou puissent rester sans risque les bateaux qui stationnaient longtemps pour décharger, où embarquer, des marchandises était à l\'étude depuis de nombreuses années3. En 1753, une esquisse de projet est présenté. Ce lieu qui occuperait l\'actuelle place Valhubert reste sans suite4.

            Plus tard, Joseph Louis Etienne Cordier5 imagine la construction d\'un canal de la Marne à la Seine, et de la Seine à la Seine, rive gauche, avec des docks dans la plaine d\'Ivry. Ce canal débutant au port-à-l\'Anglais comprenait un bassin, le bassin d\'Ivry puis après avoir longé la Seine il se terminait par un bassin hexagonal, le bassin du jardin des Plantes, d’où il rejoignait la Seine un peu au sud de l\'actuelle place Valhubert4.

            En 1762, Pierre-Louis Moreau-Desproux soumet un projet de bassin destiné a contenir pendant l\'hiver jusqu\'à 450 bateaux de marchandises à l\'abri des glaces dans la plaine d\'Ivry.
            La construction débute, en mai 1764, après l\'acceptation par les prévôt des marchands, Jean-Baptiste de Pontcarré de Viarmes, et échevins de la ville de Paris en exécution des lettres patentes du roi au 25 novembre 1762. 3 ans plus tard les travaux, sont abandonnés.',
        'lien' => 'article5.php',
        'image' => 'https://picsum.photos/1500/1000',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo Lorem Picsum',
...
function get_resume(array $article) {
