...
$point_exclamation = '!';
$point_interrogation = '?';
$prenom = 'Alexandre';     // Vous avez le droit de remplacer cette variable par votre prénom ;-)
...
// Faites-le de 2 manières différentes.
 echo $str3,  "&nbsp tout &nbsp le ", $str2, $point_exclamation, '&nbsp Je m\'appelle', $point_exclamation, $prenom, "&nbsp $str7"
// echo 
